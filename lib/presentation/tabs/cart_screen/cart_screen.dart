                ...
                Consumer<ApiProvider>(builder: (context, value, child) {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color:
                          value.getTheme == true ? Colors.black : Colors.white,
                    ),
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                        ...
                        return Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                  'PRICE DETAILS (${value.cartData.length} Item)',
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  value.totalCartValue.toStringAsFixed(2),
                  ...
                  return MyButton(
                    onTap: () {
                      payment.getPayments(
                        context: context,
                          amount: int.parse(
                              value.totalCartValue.toStringAsFixed(0)),
                          product: value.cartData);
                    },
                    text: 'PLACE ORDER',
                  );
                })
